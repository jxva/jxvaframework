...
public class DES {
	...
	public static void main(String[] args) {
		...
		if (args.length == 2) {
			...
			System.out
					.println("Wrong Parameter count , try use \"java DES -de|-en  'the string you want to be Encrypted'\"");
			...
			try {
				...
				des
						.deTest("69f18b795da1d876202693dab3f61c48412ab98820a80cccb53f442acea2941db343d91b2ec6bfc562bca1f504f0c8910d5bb33aa530d52084140a606512fe64");
			} catch (Exception ex) {
				ex.printStackTrace();
			}
