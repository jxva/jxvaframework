 ...
 * @since   1.0
 * @version 2008-11-27 09:16:20 by Jxva
 */
...
public class SequencedHashMap<K, V> implements Map<K, V>, Cloneable,Externalizable {
	...
	private final Entry<K, V> createSentinel() {
		Entry<K, V> s = new Entry<K, V>(null, null);
		s.prev = s;
		s.next = s;
		return s;
	}
	...
	private HashMap<Object, Entry<K, V>> entries;

	private transient long modCount = 0;

	public SequencedHashMap() {
		sentinel = createSentinel();
		entries = new HashMap<Object, Entry<K, V>>();
	}

	public SequencedHashMap(int initialSize) {
		sentinel = createSentinel();
		entries = new HashMap<Object, Entry<K, V>>(initialSize);
	}

	public SequencedHashMap(int initialSize, float loadFactor) {
		sentinel = createSentinel();
		entries = new HashMap<Object, Entry<K, V>>(initialSize, loadFactor);
	}
	 ...
	 * 
	 * @return The first entry in the sequence, or <code>null</code> if the map
	 *         is empty.
	 **/
	 ...
	 * optimized implementation.
	 * 
	 * @return The first key in the sequence, or <code>null</code> if the map is
	 *         empty.
	 **/
	 ...
	 * optimized implementation.
	 * 
	 * @return The first value in the sequence, or <code>null</code> if the map
	 *         is empty.
	 **/
	...
	public boolean equals(Object obj) {
		...
		return entrySet().equals(((Map<K, V>) obj).entrySet());
	}
	...
	public Set<K> keySet() {
		return new AbstractSet<K>() {
			...
			public Iterator<K> iterator() {
				return new OrderedIterator<K>(KEY);
			}

			public boolean remove(Object o) {
				Entry<K, V> e = SequencedHashMap.this.removeImpl(o);
				return (e != null);
			}
	...
	public Collection<V> values() {
		return new AbstractCollection<V>() {
			...
			public Iterator<V> iterator() {
				return new OrderedIterator<V>(VALUE);
			}
	...
	public Set<Map.Entry<K, V>> entrySet() {
		return new AbstractSet<Map.Entry<K, V>>() {
			...
			public Iterator<Map.Entry<K, V>> iterator() {
				return new OrderedIterator<Map.Entry<K, V>>(ENTRY);
			}
	...
	public Object clone() throws CloneNotSupportedException {
		...
		map.entries = new HashMap<Object, Entry<K, V>>();
