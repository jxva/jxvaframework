 ...
 * @since   1.0
 * @version 2008-11-27 09:10:59 by Jxva
 */
public class BeanHandler extends DefaultHandler {
    ...
    private Object createChild(final ElementInfo parent, final String name)
        ...
        try {
            ...
            final Class<? extends Object> parentClass = parent.bean.getClass();
    ...
    private Object createInstance(Object parent, Class<?> childClass)
        ...
        ArrayList<Constructor<?>> candidates = new ArrayList<Constructor<?>>();
     ...
     */
    private Method findCreateMethod(Class<? extends Object> objClass, String name) {
    ...
    private void setAttribute(final ElementInfo element,
        ...
        try {
            ...
            final Class<? extends Object> objClass = element.bean.getClass();
     ...
     */
    private Method findSetMethod(final Class<? extends Object> objClass,
                                 final String prefix,
                                 final String name)
            throws Exception {
