...
/**
 * Template block representation class. Here block means all the data between
 * '{' and '}' - excluding both first '{' and last '}'.
 * 
...
class Block {
	...
	/**
	 * Next index from where processing should start. It assumes a '}' at the end
	 * of each block.
	 */
	int nextIndex() {
