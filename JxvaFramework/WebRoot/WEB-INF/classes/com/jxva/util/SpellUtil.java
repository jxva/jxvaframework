 ...
 * @since   1.0
 * @version 2008-11-27 09:26:49 by Jxva
 */
public abstract class SpellUtil {
	...
	public static String getSpellByAscii(int ascii) {
		...
		for(String key:spellMap.keySet()){
			Object valObj = spellMap.get(key);
			if (valObj instanceof Integer) {
				int asciiRang = ((Integer) valObj).intValue();
				if (ascii >= asciiRang0 && ascii < asciiRang) { // 区间找到
					return (spell0 == null) ? key : spell0;
				} else {
					spell0 = key;
	 ...
	 * @return boolean
	 */
	private static boolean isAlpha(int ascii) {
	...
	public static void main(String[] args) {
		System.out.println(SpellUtil.toSpell("43"));
		System.out.println(SpellUtil.toSpell("猪八戒"));
		System.out.println(SpellUtil.toSpell("中国人的"));
	}
}