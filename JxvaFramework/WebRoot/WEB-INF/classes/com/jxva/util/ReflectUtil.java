 ...
 * @since   1.0
 * @version 2008-11-27 09:26:34 by Jxva
 */
public abstract class ReflectUtil {
    ...
    public static Object invokeMethod(Object obj, String methodName,Object...params)throws UtilException {
    	try{
	        Class<? extends Object> cls = obj.getClass();
	        if(params==null)return cls.getDeclaredMethod(methodName,new Class[]{}).invoke(obj);
	        Class<?>[] argsClass = new Class[params.length];
	        for (int i = 0;i < params.length; i++) {
	            argsClass[i] = params[i].getClass();
	        }
	        return cls.getDeclaredMethod(methodName, argsClass).invoke(obj,params);
	    }catch(Exception e){
			throw new UtilException(e);
		}
    }
    ...
    public static Object invokeStaticMethod(Class<?> cls, String methodName,Object...params) throws UtilException {
    	try{
	        if(params==null)return cls.getDeclaredMethod(methodName,new Class[]{}).invoke(null);
	        Class<?>[] argsClass = new Class[params.length];
	        for (int i = 0; i < params.length; i++) {
	            argsClass[i] = params[i].getClass();
	        }
	        return cls.getDeclaredMethod(methodName, argsClass).invoke(null,params);
    	}catch(Exception e){
			throw new UtilException(e);
		}
    }
