 ...
 * @since   1.0
 * @version 2008-11-27 13:38:58 by Jxva
 */
public class ExceptionUtil {
    ...
    public static void addCauseMethodName(String methodName) {
        if (!StringUtil.isEmpty(methodName) && !isCauseMethodName(methodName)) {            
    ...
    public static boolean isCauseMethodName(String methodName) {
        synchronized(CAUSE_METHOD_NAMES) {
            return ArrayUtil.indexOf(CAUSE_METHOD_NAMES, methodName) >= 0;
        }
    }
    ...
    public static String getMessage(Throwable th) {
        ...
        String clsName =th.getClass().getName();
