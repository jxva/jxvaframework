	...
	private static void setParameterValueInternal(
		...
		if (inValue instanceof SqlParameterValue) {
			SqlParameterValue parameterValue = (SqlParameterValue) inValue;
				...
				System.out.println("Overriding typeinfo with runtime info from SqlParameterValue: column index " + paramIndex +
...
//		System.out.println("Setting SQL statement parameter value: column index " + paramIndex +
...
//		
	 ...
	 */
	private static void setNull(PreparedStatement ps, int paramIndex, int sqlType, String typeName)throws DataAccessException {
		try{
			if (sqlType == SqlTypeValue.TYPE_UNKNOWN) {
				...
				try {
					...
					System.out.println("Could not check database or driver name");
				}
				if (useSetObject) {
	...
	private static void setValue(PreparedStatement ps, int paramIndex, int sqlType, String typeName,
			Integer scale, Object inValue) throws DataAccessException {
		try{
			if (sqlType == SqlTypeValue.TYPE_UNKNOWN) {
				if(Character.class.isAssignableFrom(inValue.getClass())){// add by jxva at 2009-03-21
					ps.setString(paramIndex, String.valueOf(inValue.toString().charAt(0)));
