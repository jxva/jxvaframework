...
public class ResultSetSupportingSqlParameter<T> extends SqlParameter {
	 ...
	 */
	public  ResultSetSupportingSqlParameter(String name, int sqlType, ResultSetExtractor<T> rse) {
		super(name, sqlType);
	 ...
	 */
	public ResultSetSupportingSqlParameter(String name, int sqlType, RowMapper<T> rm) {
		super(name, sqlType);
		this.rowMapper = rm;
	}
