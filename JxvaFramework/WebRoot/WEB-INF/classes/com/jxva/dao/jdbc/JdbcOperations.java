...
public interface JdbcOperations {
	 ...
	 * converting JDBC DataAccessExceptions into Spring's DataAccessException hierarchy.
	 * <p>The callback action can return a result object, for example a
	 * domain object or a collection of domain objects.
	 ...
	 * disconnected fashion. This wrapper will translate any DataAccessExceptions thrown.
	 ...
	 * and converting JDBC DataAccessExceptions into Spring's DataAccessException hierarchy.
	 * <p>The callback action can return a result object, for example a
	 * domain object or a collection of domain objects.
	 ...
	 * @throws DataAccessException if there is any problem issuing the update
	 * @see PreparedStatementCreatorFactory
	 * @see com.jxva.dao.jdbc.springframework.jdbc.support.GeneratedKeyHolder
	 */
