...
<body>
	<table border="1" width="100%" bgcolor="#FFFFFF" cellpadding="1" cellspacing="1">
		...
		<j:iterate name="#request.list" var="l"> 
	    <tr>
	    	<td><j:property value="#index+'x'"/></td>
	         <td><j:property value="l[0]+100"/></td>
	        <td><j:property value="l[1]+'fda'+l[3]"/></td>
	        <td><j:property value="l[2]"/></td>
	         <td><j:property value="l[3]"/></td>
	    </tr>
	    </j:iterate>
	</table>
		<a href="mtag.jv">Index</a><br/>
</body>
</html>