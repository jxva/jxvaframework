...
import com.jxva.exception.Nestable;
...
public class NestableRuntimeExceptionTestCase extends AbstractNestableTestCase {
    ...
    public void testSpecificPrintStackTrace()
    {
        ...
        assertTrue( "printStackTrace() starts with outer message", msg.startsWith("com.jxva.exception.NestableRuntimeException: outer"));
        assertTrue( "printStackTrace() contains 1st nested message", msg.indexOf("Caused by: com.jxva.exception.NestableRuntimeException: inner") >= 0);
        ...
        assertTrue( "printStackTrace() inner message after outer message", 
            msg.indexOf("com.jxva.exception.NestableRuntimeException: outer") <
            msg.indexOf("Caused by: com.jxva.exception.NestableRuntimeException: inner"));
