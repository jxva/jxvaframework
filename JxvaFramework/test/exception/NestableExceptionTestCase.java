...
public class NestableExceptionTestCase extends AbstractNestableTestCase {
    ...
    public void testSpecificPrintStackTrace()
    {
        ...
        assertTrue( "printStackTrace() starts with outer message", msg.startsWith("com.jxva.exception.NestableException: outer"));
        assertTrue( "printStackTrace() contains 1st nested message", msg.indexOf("Caused by: com.jxva.exception.NestableException: inner") >= 0);
        ...
        assertTrue( "printStackTrace() inner message after outer message", 
            msg.indexOf("com.jxva.exception.NestableException: outer") <
            msg.indexOf("Caused by: com.jxva.exception.NestableException: inner"));
