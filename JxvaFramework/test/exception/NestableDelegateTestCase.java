...
import com.jxva.exception.NestableDelegate;
...
class NestableDelegateTester1 extends Exception implements Nestable
{
     ...
     * Returns zero-length <code>Throwable</code> array for this 
     */
     ...
     * Returns zero-length String array for this 
     */
     ...
     * Returns <code>null</code> for this 
     */
...
class NonThrowableNestable implements Nestable
{
    ...
    /**
     * @see Nestable#getMessage()
     * Returns the string "non-throwable" for this 
     */
    public String getMessage()
    {
