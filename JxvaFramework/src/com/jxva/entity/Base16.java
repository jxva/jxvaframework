 ...
 * @since   1.0
 * @version Nov 26, 2008 4:20:13 PM by Jxva
 */
public abstract class Base16 {

	private static final String[] enc_codes = { "00", "01", "02", "03", "04",
	...
	public static String encode(String str) {
		...
		StringBuilder sb = new StringBuilder(l * 2);
		for (int i = 0; i < l; i++){
			sb.append(enc_codes[(byte) (str.charAt(i))]);
		}
		return sb.toString();
	}
	...
	public static String encodeBytes(byte[] bytes) {
		...
		for (int i = 0; i < bytes.length; i++){
			sb.append(enc_codes[bytes[i] & 0xFF]);
		}
		return sb.toString();
	}
}
