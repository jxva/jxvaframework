	...
	public LicenseGenerateUI(Composite parent, int style) {
			...
			groupLayout_1.createParallelGroup(GroupLayout.LEADING)
				.add(groupLayout_1.createSequentialGroup()
					...
					.add(groupLayout_1.createParallelGroup(GroupLayout.LEADING)
						...
						.add(label_1))
					.add(47, 47, 47)
					.add(groupLayout_1.createParallelGroup(GroupLayout.LEADING, false)
						.add(text_1)
						.add(text, GroupLayout.DEFAULT_SIZE, 175, Short.MAX_VALUE))
		...
		groupLayout_1.setVerticalGroup(
			groupLayout_1.createParallelGroup(GroupLayout.LEADING)
				.add(groupLayout_1.createSequentialGroup()
					...
					.add(groupLayout_1.createParallelGroup(GroupLayout.BASELINE)
						.add(label_1)
						.add(text_1, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE))
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(GroupLayout.LEADING)
				.add(groupLayout.createSequentialGroup()
					.addContainerGap()
					.add(jkhjGroup, GroupLayout.DEFAULT_SIZE, 482, Short.MAX_VALUE)
					.addContainerGap())
		);
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(GroupLayout.LEADING)
				.add(groupLayout.createSequentialGroup()
					.addContainerGap()
					.add(jkhjGroup, GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)
					.addContainerGap())
		);
