 ...
 *
 * <p>{@link com.jxva.dao.springframework.jdbc.core.JdbcTemplate} can properly apply a
 ...
 * @see com.jxva.dao.springframework.jdbc.core.JdbcTemplate#setNativeJdbcExtractor
...
public interface NativeJdbcExtractor {
	 ...
	 */
	Connection getNativeConnection(Connection con) throws DataAccessException;
	 ...
	 */
	Connection getNativeConnectionFromStatement(Statement stmt) throws DataAccessException;
	 ...
	 * @throws SQLException if thrown by JDBC methods
	 */
	Statement getNativeStatement(Statement stmt) throws DataAccessException;
	 ...
	 * @throws SQLException if thrown by JDBC methods
	 */
	PreparedStatement getNativePreparedStatement(PreparedStatement ps) throws DataAccessException;
	 ...
	 * @throws SQLException if thrown by JDBC methods
	 */
	CallableStatement getNativeCallableStatement(CallableStatement cs) throws DataAccessException;
	 ...
	 * @throws SQLException if thrown by JDBC methods
	 */
	ResultSet getNativeResultSet(ResultSet rs) throws DataAccessException;
