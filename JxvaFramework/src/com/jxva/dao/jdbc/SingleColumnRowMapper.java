...
public class SingleColumnRowMapper<T> implements RowMapper<T> {
	...
	public T mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		if (nrOfColumns != 1) {
			throw new SQLException("IncorrectResultSetColumnCountException");
		}
	 ...
	 * {@link JdbcUtil#getResultSetValue(java.sql.ResultSet, int, Class)}.
	 ...
	 * @see com.jxva.dao.jdbc.util.JdbcUtil.jdbc.support.JdbcUtils#getResultSetValue(java.sql.ResultSet, int, Class)
	 ...
	 * @return the Object value
	 * @throws SQLException in case of extraction failure
	 * @see com.jxva.dao.jdbc.util.JdbcUtil.jdbc.support.JdbcUtils#getResultSetValue(java.sql.ResultSet, int)
	 */
