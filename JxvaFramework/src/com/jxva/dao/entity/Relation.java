...
public class Relation {
	...
	public static final int FETCH=-2;	// 	TableA join fetch TableB
	public static final int CROSS=-1;  	// 	TableA cross join TableB
	public static final int DEFAULT=0; 	//	TableA,TableB
	public static final int INNER=1;	// 	TableA inner join (fetch) TableB
	public static final int LEFT=2; 	// 	TableA left (out) join (fetch) TableB
	public static final int RIGHT=3;	//	TableA right (out) join (fetch) TableB
	public static final int FULL=4;		//	TableA full (out) join (fetch) TableB
	public static final int UNION=6;	//	SelectA union SelectB
	...
	static{
		...
		relationMap.put(Relation.FETCH," join fetch ");
	}
