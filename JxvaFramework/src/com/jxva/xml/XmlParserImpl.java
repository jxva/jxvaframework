 ...
 * @since   1.0
 * @version 2008-11-27 09:18:32 by Jxva
 */
public class XmlParserImpl implements XmlParser {
    ...
    private final boolean adjustNsp() throws XmlParseException {
    ...
    private final void error(String desc) throws XmlParseException {
        if (relaxed) {
            if (error == null)
                error = "ERR: " + desc;
        }
    ...
    private final void exception(String desc) throws XmlParseException {
    ...
    private final void nextImpl() throws IOException, XmlParseException {
    ...
    */
    ...
    public void setInput(Reader reader) throws XmlParseException {
        this.reader = reader;
    ...
    public void setInput(String fileName, String inputEncoding)throws XmlParseException{
    	try{
    		setInput(new FileInputStream(fileName),inputEncoding);
    	}catch(Exception e) {
    	        throw new XmlParseException(
    	          "Invalid stream or encoding: " + e.toString(),
    	           this,
    ...
    public boolean getFeature(String feature) {
        if (XmlParser.FEATURE_PROCESS_NAMESPACES.equals(feature))
            return processNsp;
    ...
    public boolean isWhitespace() throws XmlParseException {
    ...
    public boolean isEmptyElementTag() throws XmlParseException {
        if (type != START_TAG)
            exception(ILLEGAL_TYPE);
        return degenerated;
    }
    ...
    public int getEventType() throws XmlParseException {
        return type;
    }
    ...
    public int nextToken() throws XmlParseException {
    	try{
	        isWhitespace = true;
	        txtPos = 0;
    ...
    public int nextTag() throws XmlParseException {
    ...
    public void require(int type, String namespace, String name) throws XmlParseException{
    ...
    public String nextText() throws XmlParseException{
        if (type != START_TAG)
    ...
    public void setProperty(String property, Object value)
        ...
        if(isProp(property, true, "location"))
	        ...
	        throw new XmlParseException("unsupported property: " + property);
    }
    ...
    public void skipSubTree() throws XmlParseException {
