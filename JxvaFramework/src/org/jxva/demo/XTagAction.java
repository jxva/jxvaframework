 ...
 * @since   1.0
 * @version 2009-07-02 09:14:50 by Jxva
 */
public class XTagAction extends Action{

	@Forward("/xtag/index.jsp")
	public String execute() {
		
		return SUCCESS;
	}
	
	@Forward("/xtag/array.jsp")
	public void array(){
	...
	@Forward("/xtag/condition.jsp")
	public void condition(){

	}

	@Forward("/xtag/iterate.jsp")
	public void iterate(){
		request.setAttribute("list",findBooks());
	}
	
	@Forward("/xtag/property.jsp")
