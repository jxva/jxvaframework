...
public class PressType implements Serializable{
	...
	@OneToMany(field="pressTypeId",foreignKey="pressTypeId")
	private Set<Press> pressGroup;
	...
	public Set<Press> getPressGroup() {
		return pressGroup;
	}
	public void setPressGroup(Set<Press> pressGroup) {
		this.pressGroup = pressGroup;
	}
